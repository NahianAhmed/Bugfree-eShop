							...
							<div class="header-column flex-row w-auto">
								<div class="header-logo">
									<a href="demo-product-landing.html">
										<img src="{{url('public/asset/theme')}}/img/logo-flat.png" class="img-fluid" width="87" height="42" alt="" />
									</a>
								</div>
							</div>
										...
										<div class="header-nav-main header-nav-main-arrows header-nav-main-effect-2 header-nav-main-sub-effect-1 w-100">
											<nav class="collapse w-100">
												<ul class="nav nav-pills flex-column flex-lg-row w-100" id="mainNav">
                                                    ...
                                                    <li class="dropdown">
														<a class="dropdown-item active" href="{{url('/login')}}">
															Login
														</a>
													...
													<li class="dropdown ml-lg-auto">
														...
														<ul class="dropdown-menu">
															<li><a href="#" class="dropdown-item">Link One</a></li>
															<li><a href="#" class="dropdown-item">Link One</a></li>
															<li><a href="#" class="dropdown-item">Link One</a></li>
														</ul>
													</li>
													...
													<li class="dropdown">
														<a href="#" class="dropdown-item dropdown-toggle"><img src="{{url('public/asset/theme')}}/img/blank.gif" class="flag flag-us mr-1" alt="English" /> ENGLISH</a>
														<ul class="dropdown-menu">
															<li><a href="#" class="dropdown-item"><img src="{{url('public/asset/theme')}}/img/blank.gif" class="flag flag-us" alt="English" /> English</a></li>
															<li><a href="#" class="dropdown-item"><img src="{{url('public/asset/theme')}}/img/blank.gif" class="flag flag-es" alt="Español" /> Español</a></li>
															<li><a href="#" class="dropdown-item"><img src="{{url('public/asset/theme')}}/img/blank.gif" class="flag flag-fr" alt="Française" /> Française</a></li>
														</ul>
													</li> -->
												</ul>
											</nav>
								...
								<div class="header-nav-features header-nav-features-center header-nav-features-no-border px-0">
									<div class="header-nav-feature header-nav-features-cart d-inline-flex ml-2">
										<a href="#" class="header-nav-features-toggle">
											<img src="{{url('public/asset/theme')}}/img/icons/icon-cart.svg" width="14" alt="" class="header-nav-top-icon-img">
										...
										<div class="header-nav-features-dropdown" id="headerTopCartDropdown">
											<ol class="mini-products-list">
												<li class="item">
													<a href="#" title="Camera X1000" class="product-image"><img src="{{url('public/asset/theme')}}/img/products/product-1.jpg" alt="Camera X1000"></a>
